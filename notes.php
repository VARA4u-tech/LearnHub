...
<?php require_once 'includes/header.php'; ?>
        ...
        <main class="flex-grow min-h-screen px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div class="w-full">
                ...
                <div class="mb-8 max-w-lg mx-auto">
                    <form action="notes.php" method="GET" class="flex flex-col gap-4">
                        ...
                        <a href="notes.php" class="flex w-full justify-center rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-3 text-sm font-semibold text-gray-700 dark:text-gray-300 shadow-md transition-transform duration-200 ease-in-out hover:scale-105 hover:shadow-lg hover:bg-gray-100 dark:hover:bg-gray-700">Clear Filters</a>
                    </form>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <?php else: ?>
                        <?php foreach ($notes as $note): ?>
                            <div class="bg-background-light dark:bg-background-dark p-6 rounded-lg shadow-md flex flex-col justify-between border border-primary/10 dark:border-primary/20">
                                <div>
                                ...
                                <div class="flex items-center justify-between mt-4 flex-wrap">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <?php if (isset($_SESSION['id']) && $_SESSION['id'] == $note['uploader_id']): ?>
                                            <a href="delete_note.php?id=<?php echo $note['id']; ?>" class="text-red-500 hover:underline flex-shrink-0 text-xs transition-all duration-200 hover:scale-110 hover:shadow-md" onclick="return confirm('Are you sure you want to delete this note?');"><span class="material-symbols-outlined text-xs mr-1">delete</span>Delete</a>
                                        <?php endif; ?>
                                    </div>
...
?>
        ...
        <!-- Footer -->
        <footer class="bg-background-light dark:bg-background-dark py-8 mt-12">
            <div class="container mx-auto px-4 text-center text-black/60 dark:text-white/60">
                <p>&copy; 2025 LearnHub Community. All rights reserved.</p>
            </div>
        </footer>
    </div>
