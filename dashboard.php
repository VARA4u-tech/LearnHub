...
<aside id="dashboard-sidebar" class="fixed inset-y-0 left-0 z-30 w-72 bg-background-light dark:bg-background-dark border-r border-primary/10 dark:border-white/10 p-6 flex-col transform -translate-x-full transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex">
    ...
    <nav class="flex flex-col gap-2">
        ...
        <a class="flex items-center gap-3 px-3 py-2 rounded text-primary/70 dark:text-white/70 transition-colors nav-link-underline" href="#">
...
<header class="mb-8">
<h1 class="text-3xl font-bold text-primary dark:text-white">My Notes</h1>
</header>
...
<a href="delete_note.php?id=<?php echo $note['id']; ?>" class="flex items-center justify-center w-8 h-8 rounded text-red-500 hover:bg-red-500/10 transition-all duration-200 hover:scale-110 hover:shadow-md" onclick="return confirm('Are you sure you want to delete this note?');">
