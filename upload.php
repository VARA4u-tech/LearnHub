...
<?php require_once 'includes/header.php'; ?>
        ...
        <main class="flex-grow flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            <div class="w-full max-w-2xl mx-auto">
                ...
                <div class="bg-background-light dark:bg-background-dark p-8 md:p-10 border border-primary/10 dark:border-primary/20 rounded-xl shadow-2xl shadow-primary/5 dark:shadow-primary/10">
